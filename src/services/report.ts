...
export const reportComment = async (data:{id:any,type:string},dispatch:any): Promise<any> => {
    try {
...
export const reportEvent = async (data:{id:any,type:string},dispatch:any): Promise<any> => {
    try {

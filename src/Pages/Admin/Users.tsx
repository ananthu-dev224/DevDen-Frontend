        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white rounded-lg">
            <thead className="bg-gray-50">
              <tr>
                <th className="p-2 md:p-4 border-b border-gray-200">Status</th>
                <th className="p-2 md:p-4 border-b border-gray-200">Username</th>
                <th className="p-2 md:p-4 border-b border-gray-200">Email</th>
                <th className="p-2 md:p-4 border-b border-gray-200">Joined</th>
                <th className="p-2 md:p-4 border-b border-gray-200">Action</th>
              </tr>
            </thead>
            <tbody>
              {currentItems.map((user) => (
                <tr key={user._id} className="hover:bg-gray-100">
                  ...
                  <td className="p-2 md:p-4 border-b border-gray-200">{user.email}</td>
                  <td className="p-2 md:p-4 border-b border-gray-200">
